...
import com.apps.alvarobanofos.presentview.common.view.SlidingTabLayout;

/**
 * A basic sample which shows how to use {@link com.apps.alvarobanofos.presentview.common.view.SlidingTabLayout}
...
public class SlidingTabsBasicFragment extends Fragment {
    ...
    class SamplePagerAdapter extends PagerAdapter {
        ...
        public CharSequence getPageTitle(int position) {
            switch(position) {
                case 0:
                    return "Próximas Preguntas";
                case 1:
                    return "Ranking";
                case 2:
                      return "Premios";
                case 3:
                    return "Preguntas Perdidas";
                case 4:
                    return "Preguntas contestadas";
                default:
                    return null;
            }
        }
