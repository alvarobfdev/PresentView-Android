...
public class PresentViewContentProvider extends ContentProvider {
    ...
    private static final String DATABASE_CREATE_QUESTIONS = "CREATE TABLE questions (_id integer primary key autoincrement, title text, time_ini text, time_end text, duration integer, finished integer, prize integer, prize_title text, winner integer, winner_user_id integer, winner_name text);";
